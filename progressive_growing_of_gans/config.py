...
D_loss      = EasyDict(func='loss.D_wgangp_acgan_dp')          # Options for discriminator loss.
...
desc += '-celeba_young';        dataset = EasyDict(tfrecord_dir='celeba_young'); train.mirror_augment = True
#desc += '-celeba_old';          dataset = EasyDict(tfrecord_dir='celeba_old'); train.mirror_augment = True
...
#desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 7000
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 9000
