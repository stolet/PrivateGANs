...
class TFRecordDataset:
    def __init__(self,
        ...
        with tf.compat.v1.name_scope('Dataset'), tf.device('/cpu:0'):
            ...
            output_types = tf.compat.v1.data.get_output_types(self._tf_datasets[0])
            output_shapes = tf.compat.v1.data.get_output_shapes(self._tf_datasets[0])
            ...
            self._tf_iterator = tf.compat.v1.data.Iterator.from_structure(output_types, output_shapes)
